...
final class ITConfiguration {
    private static final String DEFAULT_EXASOL_DOCKER_IMAGE_REFERENCE = "7.1.6";
    static final String ELASTICSEARCH_DOCKER_IMAGE_REFERENCE = "docker.elastic.co/elasticsearch/elasticsearch:7.17.0";
