# Virtual Schema for Elasticsearch 4.0.0, released 2026-05-27
...
* #83: Added anonymous feature-usage tracking
...
* Updated `org.slf4j:slf4j-jdk14:2.0.12` to `2.0.18`
* Removed `org.testcontainers:elasticsearch:1.19.7`
...
* Updated `org.apache.maven.plugins:maven-dependency-plugin:3.7.0` to `3.10.0`
